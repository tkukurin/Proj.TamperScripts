...
.ytp-autohide .vcs-show {visibility: visible; opacity: 1;}
/* https://igvita.com/2012/09/12/web-fonts-performance-making-pretty-fast/ */
.html5-video-player:not(.ytp-hide-info-bar) .vsc-controller {position:relative; top:60px;}
/* Facebook player */
#facebook .vsc-controller {position:relative; top: 40px;}
/* Google Photos player */
a[aria-label^="Video"] .vsc-controller {position:relative; top:35px;}
/* Google Photos full-screen view */
#player .house-brand .vsc-controller {position:relative; top:50px;}
#netflix-player:not(.player-cinema-mode) .vsc-controller {position:relative; top:85px;}
/* shift controller on vine.co, https://vine.co/v/OrJj39YlL57 */
.video-container .vine-video-container .vsc-controller {margin-left: 40px;}
/* shift YT 3D controller down, https://www.youtube.com/watch?v=erftYPflJzQ */
.ytp-webgl-spherical-control {top: 60px !important;}
.ytp-fullscreen .ytp-webgl-spherical-control {top: 100px !important;}
/* disable Vimeo video overlay */
div.video-wrapper + div.target {height: 0;}
/* Fix black overlay on Kickstarter */
div.video-player.has_played.vertically_center:before,
div.legacy-video-player.has_played.vertically_center:before{content:none !important; }
/* black overlay on openai.com */
.Shared-Video-player > .vsc-controller {height:0;}`;
